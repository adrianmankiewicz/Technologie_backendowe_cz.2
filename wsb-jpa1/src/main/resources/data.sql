...
values (1, 'John', 'Doe', '123456789', 'john.doe@example.com', 'P123', '1980-01-01'),
       (2, 'Jane', 'Smith', '987654321', 'jane.smith@example.com', 'P124', '1990-02-02');

-- Przykładowe dane dla tabeli doctor
insert into doctor (id, first_name, last_name, telephone_number, email, doctor_number, specialization)
values (1, 'Alice', 'Johnson', '555123456', 'alice.johnson@example.com', 'D001', 'CARDIOLOGY'),
